#!/usr/bin/env python
# heater PID Control
# updates: egg cooking PID control, deveritive parameter change control during cooking, platen control
...
class CookProfile:
    ...
    hoodHeight = -5200
    KeyControl = 'l'
    file_name = "log\Left_%Y%b%d_%H.%M.%S.txt"
